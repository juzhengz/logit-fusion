...
accelerate launch \
    ...
    --logit_fusion_alpha_decay_steps 2000 \
    --vllm_mode colocate \
    --output_dir /cmlscratch/juzheng/trl/checkpoints/DAPO-Qwen2.5-Math-1.5B-alpha-0.5-steps-2k-lr-1e-5-no-diff-tier-1-no-clipping \
    --learning_rate 1e-5 \
    ...
    --report_to wandb \
    --run_name DAPO-Qwen2.5-Math-1.5B-alpha-0.5-steps-2k-lr-1e-5-no-diff-tier-1-no-clipping \
    ...
    --use_difficulty_alpha_scales False \
    --difficulty_tier '<4' \
