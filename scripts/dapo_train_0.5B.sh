...
accelerate launch \
    ...
    --vllm_mode colocate \
    --output_dir /cmlscratch/juzheng/trl/checkpoints/DAPO-Qwen2.5-0.5B-alpha-0.5-steps-2k-lr-1e-5-no-diff-tier-1-no-clipping \
    --learning_rate 1e-5 \
    ...
    --report_to wandb \
    --run_name DAPO-Qwen2.5-0.5B-alpha-0.5-steps-2k-lr-1e-5-no-diff-tier-1-no-clipping \
